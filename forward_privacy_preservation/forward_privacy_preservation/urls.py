"""forward_privacy_preservation URL Configuration
...
from forward_privacy_preservation import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Threat_Status/$', remoteuser.Predict_Threat_Status, name="Predict_Threat_Status"),
    ...
    url(r'^View_Threat_Status_Ratio/$', serviceprovider.View_Threat_Status_Ratio, name="View_Threat_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Threat_Status/$', serviceprovider.View_Prediction_Of_Threat_Status, name="View_Prediction_Of_Threat_Status"),
